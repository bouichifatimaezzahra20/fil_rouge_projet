...
<body>
    ...
    if(isset($_POST["search_btn"])){
      $search = $_POST["search"];
      $where = "id_category = 2 AND (Price LIKE '$search%' OR Title LIKE '$search%')";
    ...
    include_once('db.php');
    $db = new dbConnect();
    $result = $db->selectWithPagination('product JOIN category ON Product.id_category=category.id_category ', '*', 'category.id_category = 2', 4);
